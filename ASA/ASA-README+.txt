     ...
     ******************************************************************/
     ...
     http://www.ingber.com/ under WWW.
          ...
          The  home page http://www.ingber.com/ ( https://www.ingber.com/ )
     under     WWW     (SSL     WWW),     and     the     ASCII     version
     http://www.ingber.com/00index.txt                                    (
     ...
     finance[11,12,13,14,15,16,17],
     neuroscience[18,19,20,21,22,23,24,25,26],          and          combat
     analyses[27,28,29,30,31,32,33].  Some papers illustrate  the  combined
     use  of  ASA  for  optimization  and sampling[34,35,36,37,38,39].  The
     http://www.ingber.com/asa_papers.html file in the ASA archive contains
     references to some patents and papers using ASA and VFSR.
     ...
     *exit_status  can  be  extremely  deceptive,  especially   in   highly
     ...
     [26] L.  Ingber,  "Statistical  mechanics of neocortical interactions:
          Large-scale EEG influences on molecular  processes,"  [4mJournal[24m  [4mof[0m
          [4mTheoretical[24m             [4mBiology[24m            (2016).            URL
          http://www.ingber.com/smni16_large-scale_molecular.pdf.

     [27] L. Ingber, H. Fujio, and M.F. Wehner, "Mathematical comparison of
     ...
     [28] L. Ingber and D.D. Sworder, "Statistical mechanics of combat with
     ...
     [29] L.  Ingber,  "Statistical  mechanics of combat and extensions" in
          [4mToward[24m [4ma[24m [4mScience[24m [4mof[24m [4mCommand,[24m [4mControl,[24m [4mand[24m [4mCommunications,[24m ed.  C.
          Jones,   pp.  117-149,  American  Institute  of  Aeronautics  and
          Astronautics, Washington, D.C. (1993).  ISBN  1-56347-068-3.  URL
          http://www.ingber.com/combat93_c3sci.pdf.

     [30] M.  Bowman and L. Ingber, "Canonical momenta of nonlinear combat"
     ...
     [31] L. Ingber, "Statistical Mechanics of Combat  (SMC):  Mathematical
     ...
     [36] L.   Ingber,  "Ideas  by  Statistical  Mechanics  (ISM),"  Report
          2006:ISM,  Lester  Ingber  Research,  Ashland,  OR  (2006).   URL
          http://www.ingber.com/smni06_ism.pdf.

     [37] L.  Ingber,  "Ideas by Statistical Mechanics (ISM)," [4mJ[24m [4mIntegrated[0m
     ...
     [38] L.  Ingber,  "AI  and  Ideas  by  Statistical Mechanics (ISM)" in
     ...
     [39] L. Ingber, "Adaptive Simulated Annealing"  in  [4mStochastic[24m  [4mglobal[0m
